...
const cy_stc_smif_hybrid_region_info_t S25FL128S_SlaveSlot_0_region0 =
{
...
const cy_stc_smif_hybrid_region_info_t S25FL128S_SlaveSlot_0_region1 =
{
    /* The region start address. */
...
const cy_stc_smif_hybrid_region_info_t * const S25FL128S_SlaveSlot_0_regionInfo[] = {
   &S25FL128S_SlaveSlot_0_region0,
   &S25FL128S_SlaveSlot_0_region1
};
...
const cy_stc_smif_mem_device_cfg_t deviceCfg_S25FL128S_SlaveSlot_0 =
{
    ...
    .hybridRegionCount = 2U,
    .hybridRegionInfo = (cy_stc_smif_hybrid_region_info_t**)S25FL128S_SlaveSlot_0_regionInfo
#else
